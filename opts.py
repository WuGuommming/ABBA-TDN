...
parser.add_argument('--new_length', type=int, default=5)  # number of frames for each segment
parser.add_argument('--attack_type', type=str, default="0")
# 1 same grad
# 2 grad weight
# 3 iter add motionpertu
# 4 learn motionpertu frames value
#

parser.add_argument('--zero_eps', type=float, default=1e-6)
parser.add_argument('--motion_len', type=int, default=10)
parser.add_argument('--motion_val', type=float, default=0.5)

parser.add_argument('--frame_times', type=int, default=20)
parser.add_argument('--frame_weight', type=float, default=0.2)

parser.add_argument('--step_times', type=int, default=5)
parser.add_argument('--step_weight', type=float, default=0.08)
parser.add_argument('--step_start', type=float, default=0.8)

parser.add_argument('--full_saveimg', default=False, action="store_true")
parser.add_argument('--full_savepath', type=str, default="")

parser.add_argument('--pgd_times', type=int, default=10)
parser.add_argument('--pgd_weight', type=float, default=0.02)
parser.add_argument('--pgdL2', default=False, action='store_true')

parser.add_argument('--load_from_att', default=False, action='store_true')
parser.add_argument('--gw_type', type=str, default="")
